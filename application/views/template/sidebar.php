  ...
  <div class="sidebar-wrapper active">
    <div class="sidebar-header position-relative">
      <div class="d-flex justify-content-between align-items-center">
        <div class="logo">
          <a href="<?php echo base_url('admin/dashboard'); ?>"><img style="height: 40px;" src="<?php echo base_url('uploads/'); ?>logo/e-tugas_logo_horizontal.png" alt="Logo" srcset=""></a>
        </div>
    ...
    <div class="sidebar-menu">
      <ul class="menu mb-5">
        ...
        <li
          class="sidebar-item  <?= ($this->uri->segment(1) == 'profile') ? 'active' : '' ?>">
          <a href="<?php echo base_url('dashboard'); ?>" class='sidebar-link'>
        ...
        <li
          class="sidebar-item <?= (in_array($this->uri->segment(1), ['fakultas', 'prodi', 'kaprodi', 'dosen'])) || $this->uri->segment(2) == 'set_kurikulum'  ? 'active' : '' ?> has-sub">
        ...
        <li
          class="sidebar-item <?= in_array($this->uri->segment(1), ['bk', 'cpl', 'cpmk', 'mk', 'pemetaan', 'pl', 'rangkuman']) || in_array($this->uri->segment(2), ['penyusunan_mk', 'mk_prasyarat', 'dosen_pengampu', 'indikator_mk']) ? 'active' : '' ?> has-sub">
          <a href="#" class='sidebar-link'>
          ...
          <ul class="submenu <?= in_array($this->uri->segment(1), ['bk', 'cpl', 'cpmk', 'mk', 'pemetaan', 'pl', 'rangkuman']) ? 'active' : '' ?>">
            ...
            <li class="submenu-item  <?= ($this->uri->segment(1) == 'rps')  ? 'active' : '' ?>">
              <a href="<?php echo base_url('rps'); ?>" class="submenu-link">RPS</a>
            </li>
          </ul>
        </li>
